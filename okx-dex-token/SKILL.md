---
name: okx-dex-token
description: "Search and analyze tokens with OKX DEX: token lookup by name/address, metadata, rankings, market cap, liquidity, volume, trending lists, and holder distribution across supported chains."
license: Apache-2.0
metadata:
  author: okx
  version: "1.0.1"
